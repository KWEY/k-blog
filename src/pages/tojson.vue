...
// import Utils from './pages/plugin/utils';
...
.kwe-json {
  ...
  font-size: 14px;
  line-height: 1.5;
  .kwe-type, .kwe-title, .kwe-context, .kwe-description{
    width: 60px;
    text-align: left;
    font-size: 16px;
    line-height: 40px;
  ...
  .kwe-title-input, .kwe-description-input {
    display: block;
    width: 100%;
    padding: 2px;
